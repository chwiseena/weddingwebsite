<template>
  <div class="about">
    ...
    <div class="about-paragraph">Two months later in September, Christina and Tom moved in with Jonathan and Evan. Their first apartment was rather small and a bit far away from the trains or nightlife, so in September 2019 they upgraded to their current residence. The four friends do a lot together, including board games, dungeons and dragons, and when time and quarantine allow it, beer gardens and breweries, karaoke, and relaxing getaways. The couple makes sure to have time to just the two of them, and their romance has evolved into an incredibly loving, supportive, and silly partnership.</div>
